...
| | Download |
| --- | --- |
| 🪟 **Windows** | [⬇️ Installer (Setup.exe)](https://github.com/MoritzHuyer/odyssey-launcher/releases/latest/download/Odyssey-Launcher-0.6.2-Setup.exe) |
| 🍎 **macOS (Apple Silicon)** | [⬇️ Installer (DMG)](https://github.com/MoritzHuyer/odyssey-launcher/releases/latest/download/Odyssey-Launcher-0.6.2-arm64.dmg) |
| 🐧 **Linux** | [⬇️ AppImage](https://github.com/MoritzHuyer/odyssey-launcher/releases/latest/download/Odyssey-Launcher-0.6.2-x86_64.AppImage) · [📦 .deb](https://github.com/MoritzHuyer/odyssey-launcher/releases/latest/download/Odyssey-Launcher-0.6.2-amd64.deb) |
